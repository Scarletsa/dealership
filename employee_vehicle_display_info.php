...
if (isset($_SESSION['user'])) {
  ...
  $onlotTable = "on_lot";
  $vin = '"'.$_GET['vin'].'"';
  $stmt = "SELECT DISTINCT $vehicleTable.Vin, make, model, level, year, color, listedPrice, lowestPrice, Spot, Since FROM $vehicleTable, $installedTable, $onlotTable WHERE $vehicleTable.Vin=$installedTable.Vin AND $vehicleTable.Vin=$onlotTable.Vin AND $vehicleTable.Vin=$vin";
  ...
  if (isset($_SESSION['carArray'])) {
    include 'employee_vehicle_table.php';
  }
